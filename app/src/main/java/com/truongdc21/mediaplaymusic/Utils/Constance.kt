...
object Constance {
    ...
    const val ACTION_SEND_TIME_FIRST_LOOP = "TimeFisrtLoop"
    const val ACTION_SEND_TIME_END = "TimeEND"
    const val POSITION_SONG = "sendPositionToMain"
    ...
    const val ACTION_NEXT = "33"
    const val ACTION_REMUSE = "44"
